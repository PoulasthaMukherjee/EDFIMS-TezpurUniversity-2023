<?php
	...
	$a=mysqli_query($poulastha,"SELECT * FROM faculty WHERE email='$email'");
	...
	elseif($p1!=$p2)
		{
			$info="New Password Didn't Match";
		}
		else
		{
			mysqli_query($poulastha,"UPDATE faculty SET password='$p2' WHERE email='$email'");
...
<body>
<span class="head" style="float:left">Change Password</span>
